...
export function ClientPortalBrandMark({
	className = "",
}: {
	className?: string;
}) {
	return (
		<Link
			...
			className={`inline-flex leading-none rounded-lg outline-none focus-visible:ring-2 focus-visible:ring-brand-500/60 ${className}`}
		>
