...
import {
	BlocharchWordmark,
	type WordmarkSize,
} from "@/components/BlocharchWordmark";
...
export function BrandMark({
	...
	return (
		<Link
			href="/dashboard"
			className={`group mb-0 flex rounded-lg outline-none focus-visible:ring-2 focus-visible:ring-brand-500/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-page)] ${
				stack
