...
export const TASK_TYPE_LABELS: Record<OpsTaskType, string> = {
  ...
  bathroom_drawings: "Bathroom Drawings",
  construction_detailing: "Construction Detailing",
  window_door_schedules: "Window/Door Schedules",
  area_schedules: "Area Schedules",
  drainage: "Drainage",
  setting_out_drawings: "Setting Out and Organizing Drawings",
